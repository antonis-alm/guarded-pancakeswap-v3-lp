# GuardedPancakeswapV3LpStrategy - Agent Guide

> AI coding agent context for the `guarded_pancakeswap_v3_lp` strategy.

## Overview

- **Template:** dynamic_lp
- **Chain:** bsc
- **Class:** `GuardedPancakeswapV3LpStrategy` in `strategy.py`
- **Config:** `config.json`
